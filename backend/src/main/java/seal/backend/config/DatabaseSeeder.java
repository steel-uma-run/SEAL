...
public class DatabaseSeeder implements CommandLineRunner {
  ...
  public void run(String... args) throws Exception {
    ...
    log.info("Hoàn tất nạp dữ liệu! Đã khởi tạo hàng trăm sinh viên và đội thi thành công.");
    ...
    //        trSumA,
    //        createStudent(
    //            "Lý Hải", "hail1@fpt.edu.vn", "SE200401", "Đại học FPT", StudentType.FPT,
    // defaultPwd));
    //    createTeam(
    //        "NeuralNet",
    ...
    //        trSumB,
    //        createStudent(
    //            "Đỗ Hà", "had@fpt.edu.vn", "SE180410", "Đại học FPT", StudentType.FPT,
    // defaultPwd));
    //    createTeam(
    //        "Visionary Tech",
    ...
    //        trSumB,
    //        createStudent(
    //            "Đinh Vũ", "vud@hcmus.edu.vn", "2228099", "ĐH KHTN", StudentType.EXTERNAL,
    // defaultPwd));
    //    createTeam(
    //        "ByteMe",
    ...
    //        defaultPwd);
    //    createStudent(
    //        "Vũ Gia Hân", "hanvg@fpt.edu.vn", "SE200905", "Đại học FPT", StudentType.FPT,
    // defaultPwd);
    //    createStudent(
    //        "Đặng Tuấn Phong",
    //        "phongdt@fpt.edu.vn",
    ...
    //        defaultPwd);
    //    createStudent(
    //        "Lý Anh Tuấn", "tuanla@fpt.edu.vn", "SE180908", "Đại học FPT", StudentType.FPT,
    // defaultPwd);
    //    createStudent(
    //        "Bùi Thị Bích Phương",
