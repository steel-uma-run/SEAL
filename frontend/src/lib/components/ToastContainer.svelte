...
<div class="fixed top-4 right-4 z-[100] flex flex-col gap-2 pointer-events-none">
  {#each toast.toasts as t (t.id)}
    <div
      ...
      style="background: {t.type === 'success' ? 'rgba(34, 197, 94, 0.1)' : t.type === 'error' ? 'rgba(239, 68, 68, 0.1)' : 'rgba(59, 130, 246, 0.1)'}; border-color: {t.type === 'success' ? 'rgba(34, 197, 94, 0.2)' : t.type === 'error' ? 'rgba(239, 68, 68, 0.2)' : 'rgba(59, 130, 246, 0.2)'}"
    >
      {#if t.type === 'success'}
