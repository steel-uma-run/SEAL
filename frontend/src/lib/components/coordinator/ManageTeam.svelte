<script lang="ts">
	...
	let teams = $state([
		...
		},
		{
			...
			season: "AI for Good 2026",
			track: "Cybersecurity",
			leader: "alice.smith@fptu.edu.vn",
		...
		},
		{
			id: "T-003",
			name: "Eco Warriors",
			season: "Green Tech Revolution",
			track: "Green Technology",
			leader: "bob.johnson@fptu.edu.vn",
		...
		},
		{
			...
			season: "FinTech Disruptors",
			track: "Blockchain & DeFi",
			leader: "jane.davis@fptu.edu.vn",
			leaderName: "Jane Davis",
			membersCount: 2,
			maxMembers: 5,
			status: "PENDING"
		},
		{
			...
			season: "AI for Good 2026",
			track: "Healthcare AI",
			leader: "david.wilson@fptu.edu.vn",
					...
					{#if filteredTeams.length > 0}
						{#each filteredTeams as team}
							...
							>
								...
								<td class="py-4 px-4">
									<p
										class="font-semibold text-xs {theme.darkMode
											? 'text-zinc-300'
											: 'text-gray-800'}"
									>
										{team.season}
									...
									<p
										class="text-[10px] mt-0.5 {theme.darkMode ? 'text-zinc-500' : 'text-gray-405'}"
									>
										{team.track}
									</p>
								</td>
								<td class="py-4 px-4">
									...
									<p
										class="text-[10px] mt-0.5 {theme.darkMode ? 'text-zinc-400' : 'text-gray-550'}"
									>
										{team.leader}
									</p>
								</td>
...
{#if showViewModal && selectedTeam}
	...
	>
		...
		>
			...
			<button
				onclick={() => (showViewModal = false)}
				class="mt-8 bg-zinc-500 hover:bg-zinc-650 text-white rounded-xl py-3 font-semibold transition-all w-full cursor-pointer border-0"
			>
				Close
			</button>
		</div>
