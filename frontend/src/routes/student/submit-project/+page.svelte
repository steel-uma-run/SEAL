...
<div class="max-w-2xl mx-auto w-full p-6 md:p-10">
    ...
    >
        <div class="flex items-center gap-4 mb-8 border-b pb-6 {theme.darkMode ? 'border-zinc-800' : 'border-gray-100'}">
            ...
            <div>
                <h1 class="text-2xl font-bold {theme.darkMode ? 'text-zinc-100' : 'text-gray-800'}">Submit Project</h1>
                <p class="text-sm mt-1 {theme.darkMode ? 'text-zinc-400' : 'text-gray-500'}">Submit your team's final work for evaluation.</p>
            </div>
        </div>

        <form onsubmit={handleSubmit} class="flex flex-col gap-6">
            <div class="space-y-2">
                <label class="text-sm font-semibold {theme.darkMode ? 'text-zinc-300' : 'text-gray-700'}">Git Link (Required)</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 {theme.darkMode ? 'text-zinc-600' : 'text-gray-400'}" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-2">
                <label class="text-sm font-semibold {theme.darkMode ? 'text-zinc-300' : 'text-gray-700'}">YouTube Link (Optional)</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 {theme.darkMode ? 'text-zinc-600' : 'text-gray-400'}" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="space-y-2">
                <label class="text-sm font-semibold {theme.darkMode ? 'text-zinc-300' : 'text-gray-700'}">Presentation Slide Link</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 {theme.darkMode ? 'text-zinc-600' : 'text-gray-400'}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {#if submitMessage}
                <div
                    ...
                    {theme.darkMode ? 'bg-blue-950/20 text-blue-400 border-blue-900/50' : 'bg-blue-50 text-blue-700 border border-blue-100'}"
                >
