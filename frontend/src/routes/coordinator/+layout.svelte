...
{:else}
	<div class="font-sans min-h-screen transition-colors duration-300 bg-(--md-surface) text-(--md-on-surface)">
		<Sidebar {menuItems} />

		<main class="md:ml-64 flex-1 flex flex-col min-h-screen transition-colors duration-300 bg-(--md-surface)">
